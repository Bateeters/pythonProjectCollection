...
def getSelection(dropdown):
    ...
    if selection == 'Aphrodite':  # If Aphrodite is selected in the menu
        # Sets new window and adds color
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Aphrodite.png")
        resized_image = image1.resize(
            (125, 175), Image.ANTIALIAS)  # Resizing photo
        # Defines photo for use in label
        test = ImageTk.PhotoImage(resized_image)
        label1 = tk.Label(aphrodite, image=test,
                          bg='lightpink')  # Label for photo
        ...
        mainscreen.place(relx=0.25, rely=0.8, relwidth=0.5,
                         relheight=0.2)  # Home button placement
    ...
    # Apollo Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Apollo.png")
    ...
    # Ares Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Ares.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Artemis Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Artemis.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Athena Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Athena.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Demeter Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Demeter.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Dionysus Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Dionysus.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Hades Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Hades.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Hephaestus Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Hephaestus.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Hera Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Hera.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Hermes Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Hermes.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Poseidon Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Poseidon.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
    ...
    # Zeus Page (code serves same purpose as previous pages)
        ...
        image1 = Image.open(
            "greekKnowledgeFinder/assets/GreekGodBanners/Zeus.png")
        resized_image = image1.resize((125, 175), Image.ANTIALIAS)
        test = ImageTk.PhotoImage(resized_image)
...
# Frame location placement
large.place(relx=0, rely=0, relwidth=1, relheight=1)

# main page photo
# Sets photo for home page
photo = tk.PhotoImage(
    file="greekKnowledgeFinder/assets/building1.png")
...
frame.place(relx=0.5, rely=0.25, relwidth=0.75,
            relheight=0.5, anchor='n')  # Menu frame placement

# Text above list
label = tk.Label(frame, text="Learn About the Greek God or Goddess:",
                 bg='black', fg='white', font=100)  # Adds text above list
# Text above list placement
...
dropdown.place(relx=0, rely=0.5, relwidth=0.65,
               relheight=0.5)  # List location placement

# search button
search = tk.Button(frame, text="Search", fg='blue', font=40, command=lambda: [
                   getSelection(dropdown)])  # Search button function
search.place(relx=0.7, rely=0.5, relwidth=0.3,
             relheight=0.5)  # Search button placement
